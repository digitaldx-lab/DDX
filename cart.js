...
class CartSystem {
    ...
    createCartIcon() {
        ...
        if (header) {
            const contactLi = header.querySelector('.contact');
            if (contactLi && contactLi.parentElement) {
                contactLi.parentElement.parentElement.insertBefore(
                    document.createElement('li'),
                    contactLi.parentElement
                ).outerHTML = `<li>${this.cartIcon.outerHTML}</li>`;
            } else {
                header.querySelector('.nav-links').innerHTML += `<li>${this.cartIcon.outerHTML}</li>`;
            }
        }
